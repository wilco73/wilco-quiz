    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 sm:p-6 overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
          <h2 className="text-xl sm:text-2xl font-bold dark:text-white">Banque de Questions</h2>

          {/* Bouton Nouvelle Question - toujours visible */}
          <button
            onClick={handleNewQuestion}
            className="flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition font-semibold w-full sm:w-auto"
          >
        ...
        {/* Boutons d'action CSV - grille responsive */}
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 mb-4">
          {/* Sélecteur de délimiteur CSV */}
          <select
            value={csvDelimiter}
            onChange={(e) => setCsvDelimiter(e.target.value)}
            className="px-2 sm:px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-xs sm:text-sm col-span-2 sm:col-span-1"
          ...
          <button
            ...
            className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/50 transition text-xs sm:text-sm"
            title="Télécharger un fichier template CSV avec exemples"
          >
            <Download className="w-3 h-3 sm:w-4 sm:h-4" />
            <span className="hidden xs:inline">Template</span> CSV
          </button>

          <button
            onClick={() => fileInputRef.current?.click()}
            className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-200 dark:hover:bg-green-900/50 transition text-xs sm:text-sm"
          ...
          <button
            ...
            className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 rounded-lg hover:bg-orange-200 dark:hover:bg-orange-900/50 transition text-xs sm:text-sm"
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 rounded-lg transition text-xs sm:text-sm col-span-2 sm:col-span-1 ${
              showPreview
                ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300'
                : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400'
              }`}
          >
            {showPreview ? <Eye className="w-3 h-3 sm:w-4 sm:h-4" /> : <EyeOff className="w-3 h-3 sm:w-4 sm:h-4" />}
