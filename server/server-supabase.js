 ...
 * Supabase (PostgreSQL) pour la persistance des donnees
...
async function broadcastGlobalState() {
  ...
  const participants = (await db.getAllParticipants()).map(p => ({ ...p, password: '********' }));
...
app.post('/api/participants/create', async (req, res) => {
...
app.put('/api/participants/:id/password', async (req, res) => {
  const { id } = req.params;
...
app.put('/api/participants/:id/avatar', async (req, res) => {
  const { id } = req.params;
...
app.post('/api/update-participant', async (req, res) => {
...
app.put('/api/lobbies/:id/archive', async (req, res) => {
  const { id } = req.params;
...
app.post('/api/drawing-words/import', async (req, res) => {
...
app.post('/api/drawing-references/import', async (req, res) => {
...
app.get('/api/drawing-games', async (req, res) => {
  res.json(await db.getAllDrawingGames());
});

app.post('/api/drawing-games', async (req, res) => {
  const game = await db.createDrawingGame(req.body);
  broadcastGlobalState();
  res.json({ success: true, game });
});

app.put('/api/drawing-games/:id', async (req, res) => {
  const game = await db.updateDrawingGame(req.params.id, req.body);
  broadcastGlobalState();
  res.json({ success: true, game });
});

app.delete('/api/drawing-games/:id', async (req, res) => {
...
app.get('/api/drawing-lobbies', async (req, res) => {
  res.json(await db.getAllDrawingLobbies());
});

app.get('/api/drawing-lobbies/:id', async (req, res) => {
...
app.post('/api/drawing-lobbies', async (req, res) => {
  const lobby = await db.createDrawingLobby(req.body);
  broadcastGlobalState();
  res.json({ success: true, lobby });
});

app.delete('/api/drawing-lobbies/:id', async (req, res) => {
  ...
  await db.deleteDrawingLobby(req.params.id);
  broadcastGlobalState();
...
app.post('/api/drawing-lobbies/:id/archive', async (req, res) => {
...
app.post('/api/drawing-lobbies/:id/custom-words', async (req, res) => {
...
app.get('/api/drawing-lobbies/:id/results', async (req, res) => {
...
app.get('/api/drawing-lobbies/:id/drawings', async (req, res) => {
  const drawings = await db.getDrawingsByLobby(req.params.id);
  res.json(drawings);
});

// Récupérer les dessins d'un lobby spécifique
app.get('/api/drawings/lobby/:lobbyId', async (req, res) => {
